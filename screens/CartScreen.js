...
export default function CartScreen() {
    ...
    return (
        <View className="bg-white flex-1">
            ...
            >
                <Image source={require('../assets/images/bickerguy.png')} className="w-20 h-20 rounded" />
            ...
            <View style={{backgroundColor:themeColors.bgColor(0.2)}} className="p-6 px-8 rounded-t-3xl space-y-4">
                <View className="flex-row justify-between">
                    ...
                    <Text className="text-gray-700" >{cartTotal} TND</Text>
                </View>
                <View className="flex-row justify-between">
                    <Text className="text-gray-700">Delivery Fee</Text>
                    <Text className="text-gray-700" >{deliveryFee} TND</Text>
                </View>
                <View className="flex-row justify-between">
                    <Text className="text-gray-700 font-extrabold">Order Total</Text>
                    <Text className="text-gray-700 font-extrabold" >{deliveryFee+cartTotal} TND</Text>
                </View>
                <View>
                    <TouchableOpacity
